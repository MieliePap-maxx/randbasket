...
-- Optional, consented basket-selection events. A secret-keyed hash replaces the
-- random installation ID before storage; these events are not purchase records.
